...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://smpbocilcolmek.pages.dev/v/${file.filecode}#${file.title}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://smpbocilcolmek.pages.dev/v/${file.filecode}#${file.title}`
            }  
        }
        }
    return (
